...
↑↑↑设置界面首先推荐设置的是DeepSeek的API Key，由于能力有限且不想让app太臃肿，且deepseek-v4-flash模型能力在翻译方面已足够好用且便宜，因此这里就固定了，以减少操作复杂性。你只需在DeepSeek官网控制台页面充值即可（点击页面超链接可直接跳转），不用充太多，十块钱可以用很久，目前统计翻译100条文献标题及摘要大约1毛钱
...
↑↑↑这里可以看到，app直接将输入的「脓毒症 Cell Nature Science」转换成了pubmed可识别的索引格式并生成了RSS订阅链接。事实上如果你不用来追踪文献，仅仅是用来订阅一些外文的RSS源，也是可以的，直接在首页左栏输入框中添加订阅源即可
...
首先我必须要承认，我是一个对代码完全没有学习过的人，我的本专业是临床医学，在我的硕博生活中，阅读文献是日常生活的重要一部分，当然我必须要承认我的英文水平还远没有好到可以流畅阅读文献的地步，因此借助翻译工具也是必不可少的。之前曾热衷于使用 Zotero 来管理我的文献，也装了很多插件，后来发现反而还是在官网阅读更加纯享，更加便捷，如果遇到特别好的文献再用 Obsidian 管理笔记，因此逐渐就放弃 Zotero 了

但这也带来一个麻烦，Zotero 自带的 RSS 追踪功能还是蛮好用的，但我又不想仅仅为了这一个功能再去下载一个大几百 MB 的软件，作为一个三十岁的人，已经过了喜欢折腾那些拥有花里胡哨大而全功能的 app 了，现在更喜欢轻量的且功能聚焦的工具 app

市面上好用的 RSS 阅读器有很多，不乏很多轻量的界面好看的 RSS 阅读器，但我试用了许多，总觉得无法满足我的需求——我并不需要抓取全文的功能——事实上医学论文也很难抓取全文。而对于一次追踪许多领域进展的人来说，能够快速自动翻译标题和摘要来判断文章的价值就尤为重要，是的，其实到某一时期，最重要最烦的是筛选粗读文献，读文献反倒并不痛苦了

这里也要感谢GitHub上的一个项目 MrRSS，让我想到为何不结合现在的大模型能力，将抓取后的文献标题和摘要快速翻译呢？

感谢 Claude、Codex、DeepSeek，让我通过 vibe coding 来实现了我的想法。作为一个完全完全对代码不懂的人，别说三年前，就是在一年前我都不敢想象我能做一个 app 出来
...
这段时间真的获益很多，感谢这个时代可以让每个人都能像动笔写文章一样来写一个自己想要的工具，代码就像文字一样不再是遥不可及的。当然我必须要向专业的代码专家致敬，在这个过程中才知道你们过去「古法编程」的难度，并且时至今日我也认为，AI 虽然可以让工具跑起来，但专业的人工审核监督会变得更加有价值。
